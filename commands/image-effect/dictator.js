...
module.exports = {
        name: 'dictator',
        description: 'Bạn đang được ca ngợi như Bác Hồ!',
        aliases: ["dic"],
        usage: '_dictator / _dic <@user>',
    ...
    run: async (client, message, args) => {
        ...
        let buffer = await AmeAPI.generate("dictator", { url: user.user.displayAvatarURL({ format: "png", size: 2048 }) });
